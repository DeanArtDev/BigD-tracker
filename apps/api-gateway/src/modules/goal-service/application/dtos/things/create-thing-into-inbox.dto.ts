...
class CreateThingIntoInboxReqData {
...
class CreateThingIntoInboxReq {
  @ApiProperty({
    description: 'Запрос сервера',
    type: CreateThingIntoInboxReqData,
  })
  @ValidateNested()
  @Type(() => CreateThingIntoInboxReqData)
  data: CreateThingIntoInboxReqData;
}

class CreateThingIntoInboxRes {
...
export { CreateThingIntoInboxReq, CreateThingIntoInboxRes };
