...
import { GroupInboxResolver, GroupsQueriesResolver } from './groups/presentation/graphql';
...
@Module({
  providers: [GroupInboxResolver, TasksMutationsResolver, TasksQueriesResolver, GroupsQueriesResolver],
