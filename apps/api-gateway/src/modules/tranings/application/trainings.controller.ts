...
export class TrainingsController {
  ...
  async stratTraining(
    ...
    await this.trainingClient.send<TrainingStartTraining.Response, TrainingStartTraining.Request>(
  ...
  async finishTraining(
    ...
    await this.trainingClient.send<TrainingFinishTraining.Response, TrainingFinishTraining.Request>(
  ...
  async setBrakFact(
    ...
    await this.trainingClient.send<TrainingSetBreakFact.Response, TrainingSetBreakFact.Request>(
  ...
  async deleteTraining(
    ...
    await this.trainingClient.send<TrainingDeleteTraining.Response, TrainingDeleteTraining.Request>(
