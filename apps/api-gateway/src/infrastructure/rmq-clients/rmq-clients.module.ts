...
import { AccountServiceClientProxy } from './account-service-client-proxy';
...
@Global()
@Module({
  providers: [GoalServiceClientProxy, AccountServiceClientProxy],
  imports: [
  ...
  exports: [ClientsModule, GoalServiceClientProxy, AccountServiceClientProxy],
})
