...
const validator = new DomainValidator('exercises');
...
class ExerciseEntity {
  ...
  update(data: UpdateData): this {
    const { description, name, type, exampleUrl, position } = data;

    if (position != null) this.data.position = position;
    this.data.name = name;
    this.data.type = type;
...
export { ExerciseEntity, ExerciseData };
