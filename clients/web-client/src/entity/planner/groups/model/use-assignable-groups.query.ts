...
import { shapeGetAssignableGroupsOptions, useExtendApolloErrorResult } from '@/shared/transport/graphql';
import { BrandGroup } from './domain';
import { GetAssignableGroupsQuery } from './schemas/groups.schema.generated';
...
function useGetAssignableGroups() {
  const result = useQuery(...shapeGetAssignableGroupsOptions<Query>().query());
