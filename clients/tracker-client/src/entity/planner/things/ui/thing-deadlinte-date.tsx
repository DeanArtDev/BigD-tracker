...
type ThingDeadlineDateProps = ComponentProps<typeof CalendarClock> & {
  readonly deadline?: Date;
  readonly showDate?: boolean;
};

function ThingDeadlineDate({ deadline, showDate = false, ...svgProps }: ThingDeadlineDateProps) {
...
export { ThingDeadlineDate, type ThingDeadlineDateProps };
